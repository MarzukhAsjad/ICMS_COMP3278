...
def try_login(user_name):
    # 1 Create database connection
    myconn1 = mysql.connector.connect(host="localhost", user="root", passwd="123456", database="facerecognition")
    ...
    while True:
        ...
        cv2.imshow('Intelligent Course Management System', frame)
